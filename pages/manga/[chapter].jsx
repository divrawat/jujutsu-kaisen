...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const DESCRIPTION = `Read ${MANGA_NAME} chapter ${chapterNumber} online at ${DOMAIN}. Yuji Itadori, a high school student who joins a secret organization of jujutsu sorcerers. He battles curses after becoming the host of a powerful curse named Ryomen Sukuna. The series combines supernatural action with dark fantasy elements.`
