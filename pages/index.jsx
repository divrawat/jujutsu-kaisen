...
export default function Home() {
  const chapters = Array.from({ length: chaptersData.length }, (_, i) => ({
    number: i + 1,
    url: `${DOMAIN}/${URL_PREFIX}-${i + 1}`
  })).reverse();
    ...
    <>
      ...
      <article>
        ...
        {/* <div className="md:flex md:mb-[60px] mb-5 pt-3 relative bg-[black]">
          <div className="absolute inset-0 bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url('https://images4.alphacoders.com/133/1332281.jpeg')`, opacity: '0.25' }}></div>

          <div className="pt-3 md:w-2/5">
            <img className="mx-auto md:mx-0" width={430} height={430} src={`${COVER_IMG}`} alt={`${MANGA_NAME} Manga Cover`} />
          </div>

          <div className="md:w-3/5 md:mr-10 text-white p-5 relative z-10">
            <h1 className="text-center font-extrabold text-4xl myb-5 mt-1 uppercase">{MANGA_NAME}</h1>
        ...
        <div className="md:flex md:mb-[60px] mb-5 pt-3 relative bg-[black]">
          <div class="absolute inset-0 bg-cover bg-no-repeat bg-center opacity-15 z-0" style={{ backgroundImage: `url('https://images4.alphacoders.com/133/1332281.jpeg')` }}></div>
          <div className="pt-3 md:w-2/5">
            <img className="mx-auto md:mx-0 z-50" width={430} height={430} src={`${COVER_IMG}`} alt={`${MANGA_NAME} Manga Cover`} />
          </div>
          <div className="md:w-3/5 md:mr-10 text-white p-5 relative z-10">
            <h1 className="text-center font-extrabold text-4xl myb-5 mt-1 uppercase">{MANGA_NAME}</h1>
            <p className="my-5 leading-[2] px-6 text-center" dangerouslySetInnerHTML={{ __html: MANGA_DESCRIPTION }} />
