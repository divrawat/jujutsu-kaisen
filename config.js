...
export const MANGA_NAME = 'Jujutsu Kaisen (JJK)';
export const MANGA_AUTHOR = 'Gege Akutami';
export const MANGA_RELEASE = '2018';
export const MANGA_STATUS = 'Ongoing';
export const MANGA_ARTIST = 'Gege Akutami';
export const MANGA_STUDIO = 'MAPPA';
export const MANGA_GENRE = 'Action, Adventure, Horror, Mystery, Shonen';

export const CHAPTER_PREFIX = 'jujutsu-kaisen-chapter';
export const IMAGE_PREFIX = 'images/jujutsu-kaisen';
export const NEXT_PREVIOUS_PREFIX = 'manga/jujutsu-kaisen-chapter';
export const URL_PREFIX = 'manga/jujutsu-kaisen-chapter';

export const AUTHOR_PAGE = `${DOMAIN}/jujutsu-kaisen-team`;
...
// Navbar
export const logo = <img src={`${DOMAIN}/logo.webp`} alt="Logo" className="h-[75px] w-[120px] mr-5 md:ml-0 ml-4 md:pb-2 md:my-0 my-1" />
...
export const MANGA_SUMMARY = [
    {
        id: 1,
        content: "Jujutsu Kaisen is a captivating manga series that revolves around Yuji Itadori, a seemingly ordinary high school student with exceptional physical abilities. Yuji's life takes a dramatic turn when he encounters a cursed object—an old, powerful finger belonging to a fearsome demon named Ryomen Sukuna."
    },
    {
        id: 2,
        content: "Yuji's involvement with the supernatural begins when he and his friends from the Occult Club unseal the cursed finger, attracting dangerous curses to their school. To save his friends from a deadly curse, Yuji makes a bold decision to swallow the finger. This act grants him immense power but also makes him the host of Sukuna, an evil and powerful curse."
    },
    {
        id: 3,
        content: "Instead of being executed for hosting such a dangerous entity, Yuji is given a chance to join the Tokyo Metropolitan Magic Technical College, a school for Jujutsu Sorcerers. These sorcerers are dedicated to protecting humanity by battling curses and other supernatural threats. Yuji's mission is clear: to find and consume all of Sukuna's remaining fingers, thus eliminating the demon once and for all."
    },
    {
        id: 4,
        content: "At the college, Yuji teams up with other students, including the stoic and skilled Megumi Fushiguro and the fierce and determined Nobara Kugisaki. Together, they train under the watchful eye of their mentor, Satoru Gojo, who is one of the most powerful and enigmatic sorcerers in the world."
    },
    {
        id: 5,
